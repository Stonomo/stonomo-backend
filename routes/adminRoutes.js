...
router.post('/test-admin', authenticateAdminToken, async (_req, res) => {
	console.log('Admin route hit');
	res.send('Admin route success');
})

router.post('/populate-reasons', authenticateAdminToken, async (_req, res) => {
	console.log("Populating Reasons List");
	await populateReasons();
	res.send('Reasons updated');
});

router.post('/load-test-evictions', authenticateAdminToken, async (_req, res) => {
	try {
...
router.post('/load-sample-data', authenticateAdminToken, async (_req, res) => {
	try {
